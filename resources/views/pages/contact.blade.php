...
<section class="pt-12 sm:pt-16">
  <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 grid md:grid-cols-2 gap-6">
      <form method="POST" action="{{ route('contact.store') }}" class="rounded-2xl border border-white/10 bg-white/5 p-6">
        @csrf
        @if(session('success'))
      ...
      <div class="rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <p class="text-white/70 mt-2 text-sm">info.inertlab@gmail.com<br/>+7 (985) 194-45-55<br/>+7 (962) 977-42-51<br/>Россия</p>
