...
<section class="pt-12 sm:pt-16">
  <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    ...
    <p class="text-white/70 mt-4">Компания Inertlab была основана в 2025 году в рамках акселератора. Наша миссия - реализовать IMU на территории Росси для удовлетворения спроса. Мы стремимся разработать универсальный БЧЭ для максимальной простоты интеграции наших модулей в ваши проекты</p>
