      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative" data-aos="fade-left">
          <div class="relative rounded-2xl border border-white/10 bg-white/5 p-4 shadow-glow">
            <img src="{{ asset('assets/mvp.jpg') }}" onerror="this.onerror=null;this.src='{{ asset('assets/mvp.png') }}'" alt="IMU MVP" class="rounded-lg object-contain w-full h-[360px]"/>
      ...
      <div class="grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div class="relative" data-aos="fade-left">
          <div class="rounded-2xl overflow-hidden border border-white/10 bg-white/5">
            <img src="{{ asset('assets/mvp.jpg') }}" onerror="this.onerror=null;this.src='{{ asset('assets/mvp.png') }}'" alt="MVP" class="w-full h-[420px] object-cover" />
          </div>
        </div>
      </div>
    </div>
