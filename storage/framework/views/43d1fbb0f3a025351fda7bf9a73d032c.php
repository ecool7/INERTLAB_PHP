...
<html lang="ru" class="scroll-smooth">
  <head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Inertlab — Инерциальные модули IMU, произведенные в России'); ?></title>
        ...
        <div class="flex h-[5.33rem] items-center justify-between">
          <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 group">
            <span class="h-[5rem] w-[5rem] rounded-full bg-white flex items-center justify-center">
              <img src="<?php echo e(asset('assets/logoo111.svg')); ?>" alt="Inertlab" class="h-[4rem] w-[4rem]" />
            </span>
            <span class="text-white/90 group-hover:text-white font-semibold tracking-tight">Inertlab</span>
          </a>
          <nav class="hidden md:flex items-center gap-8 text-sm">
            <a href="<?php echo e(route('products')); ?>" class="hover:text-white/90 text-white/70">Продукция</a>
            <a href="<?php echo e(route('about')); ?>" class="hover:text-white/90 text-white/70">О компании</a>
            <a href="<?php echo e(route('contact')); ?>" class="hover:text-white/90 text-white/70">Контакты</a>
          </nav>
          <a href="<?php echo e(route('contact')); ?>" class="hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-ink-500 hover:bg-ink-600 shadow-glow transition">
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-3 gap-8 text-white/60">
        <div>
          <div class="flex items-center gap-3 mb-4">
            <span class="h-[4.5rem] w-[4.5rem] rounded-full bg-white flex items-center justify-center">
              <img src="<?php echo e(asset('assets/logoo111.svg')); ?>" class="h-[3.5rem] w-[3.5rem]" alt="Inertlab" />
            </span>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li><a href="<?php echo e(route('home')); ?>" class="hover:text-white">Главная</a></li>
            <li><a href="<?php echo e(route('products')); ?>" class="hover:text-white">Продукция</a></li>
            <li><a href="<?php echo e(route('about')); ?>" class="hover:text-white">О компании</a></li>
            <li><a href="<?php echo e(route('contact')); ?>" class="hover:text-white">Контакты</a></li>
          </ul>
        </div>
        <div>
          <h3 class="text-white/80 font-medium mb-3">Контакты</h3>
          <p class="text-sm">info.inertlab@gmail.com<br/>+7 (985) 194-45-55<br/>+7 (962) 977-42-51<br/>Россия</p>
        </div>
      </div>
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 text-xs text-white/50">© <?php echo e(date('Y')); ?> Inertlab. Все права защищены.</div>
    </footer>
...
<?php /**PATH /Users/evgenijgubyrin/Desktop/inertlab_PHP/resources/views/layouts/app.blade.php ENDPATH**/ ?>