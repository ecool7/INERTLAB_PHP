<?php $__env->startSection('title', 'Inertlab — Российские инерциальные модули IMU для промышленности и робототехники'); ?>
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div data-aos="fade-up">
          ...
          <div class="mt-8 flex items-center gap-4">
            <a href="<?php echo e(route('products')); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-ink-500 hover:bg-ink-600 shadow-glow transition font-medium">Каталог IMU</a>
            <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-lg border border-white/10 hover:border-white/20 bg-white/5 hover:bg-white/10 transition font-medium">Получить консультацию</a>
          </div>
        ...
        <div class="relative" data-aos="fade-left">
          <div class="relative rounded-2xl border border-white/10 bg-white/5 p-4 shadow-glow">
            <img src="<?php echo e(asset('assets/mvp.jpg')); ?>" onerror="this.onerror=null;this.src='<?php echo e(asset('assets/mvp.png')); ?>'" alt="IMU MVP" class="rounded-lg object-contain w-full h-[360px]"/>
      ...
      <div class="grid lg:grid-cols-2 gap-8 items-center">
        <div data-aos="fade-right">
          ...
          <div class="mt-6 flex gap-3">
            <a href="<?php echo e(route('products')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-ink-500 hover:bg-ink-600 shadow-glow">Смотреть линейку</a>
            <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-white/10 hover:border-white/20 bg-white/5 hover:bg-white/10">Обсудить проект</a>
          </div>
        </div>
        <div class="relative" data-aos="fade-left">
          <div class="rounded-2xl overflow-hidden border border-white/10 bg-white/5">
            <img src="<?php echo e(asset('assets/mvp.jpg')); ?>" onerror="this.onerror=null;this.src='<?php echo e(asset('assets/mvp.png')); ?>'" alt="MVP" class="w-full h-[420px] object-cover" />
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="rounded-2xl border border-white/10 bg-gradient-to-r from-ink-600 to-ink-500 p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6" data-aos="zoom-in">
        ...
        <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-white text-night font-medium hover:bg-white/90 transition">Связаться</a>
      </div>
    </div>
  </section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/evgenijgubyrin/Desktop/inertlab_PHP/resources/views/pages/index.blade.php ENDPATH**/ ?>